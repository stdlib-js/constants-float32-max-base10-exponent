...
```javascript
FLOAT32_MAX_BASE10_EXPONENT = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-max-base10-exponent@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-max-base10-exponent/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float32-max-base10-exponent/actions/workflows/test.yml?query=branch:v0.1.0
